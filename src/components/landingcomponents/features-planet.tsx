...
import PlanetImg from "../../../public/images/images/planet.png";
import PlanetOverlayImg from "../../../public/images/images/planet-overlay.svg";
import PlanetTagImg01 from "../../../public/images/images/planet-tag-01.png";
import PlanetTagImg02 from "../../../public/images/images/planet-tag-02.png";
import PlanetTagImg03 from "../../../public/images/images/planet-tag-03.png";
import PlanetTagImg04 from "../../../public/images/images/planet-tag-04.png";
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              CoreView helps your teams work more efficiently together
            </h2>
          </div>
          {/* Planet */}
